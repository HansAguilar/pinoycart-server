...
const OrderSchema = new mongoose_1.Schema({
    customerID: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'users', required: true },
    items: [
        {
...
const OrderModel = mongoose_1.default.model("orders", OrderSchema); //^ (String: name of table, Object: fields ng table)
